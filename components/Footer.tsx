  ...
  return (
    <footer className="bg-ink-900 text-ink-100">
      ...
      <Container className="grid grid-cols-1 gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <h3 className="text-sm font-bold uppercase tracking-wide text-hazard-400">
            Company Info
          </h3>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5">
            {footerServices.map((service) => (
              <li key={service} className="text-sm text-ink-200">
                {service}
              </li>
            ))}
          </ul>
        ...
        <div>
          ...
          >
            <PhoneIcon className="h-4 w-4 text-hazard-400" />
            Call: +1-{site.phone}
          </a>
      ...
      <div className="border-t border-white/10">
        <Container className="flex flex-col items-center justify-between gap-3 py-6 text-xs text-ink-300 sm:flex-row">
          <p>
